...
function inferCategoryFromText(type: 'expense' | 'income', text: string): string {
...
function inferTags(type: 'expense' | 'income', note: string, category: string, currentTags: string[]): string[] {
  ...
  const handleSaveBill = () => {
    ...
    parsedBill.transactions.forEach((item) => {
      ...
      addTransaction({
        ...
        tags: finalTags,
        categoryId: resolveCategoryId(finalCategory),
